...
public class RPCLiteralServiceClient {
	...
	/*@WebServiceRef(type=RPCLiteralService.class)
	static RPCLiteralServiceSEI rpcLiteralService;*/
	...
	public static void main(String... str){
		...
		((BindingProvider)rpcLiteralService).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY,"http://localhost:7700/style/rpcliteral/RPCLiteralServiceSEI");
		resBo =  rpcLiteralService.getExchangeRate(reqBO, "INR");
		
	
		System.out.println("successful executed ws "+resBo.getAmount()+" curr:"+resBo.getCurrency());
